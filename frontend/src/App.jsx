      ...
      <Router>
        <Routes>
          ...
          <Route
            ...
            element={
              <PrivateRoute adminOnly={true} element={AdminAddProductPage} />
            }
          />
          <Route
            path="/admin/edit-product"
            element={
              <PrivateRoute adminOnly={true} element={AdminEditProductPage} />
            }
          />
          <Route
            path="/admin/edit-product/:productId"
            element={
              <PrivateRoute adminOnly={true} element={EditSingleProductPage} />
            }
          />
          ...
          <Route
            path="/account/"
            element={<PrivateRoute adminOnly={false} element={AccountPage} />}
          />
          <Route
          ...
          <Route
            path="/checkout"
            element={<PrivateRoute adminOnly={false} element={CheckoutPage} />}
          />
          <Route
            path="/account/address"
            element={<PrivateRoute adminOnly={false} element={AddressPage} />}
          />
